...
@Component({
  selector: 'app-update-photo-profil-g',
  templateUrl: './update-photo-profil-g.component.html',
  styleUrls: ['./update-photo-profil-g.component.css']
})
export class UpdatePhotoProfilGComponent implements OnInit, OnDestroy {
