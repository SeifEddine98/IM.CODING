...
public class administrateur implements Serializable {
	...
	public administrateur(Integer id, Long cin, String nom, String prenom, String adresse, Date dateNaiss, String email,
	...
	public String toString() {
		return "administrateur [id=" + id + ", cin=" + cin + ", nom=" + nom + ", prenom=" + prenom + ", adresse="
